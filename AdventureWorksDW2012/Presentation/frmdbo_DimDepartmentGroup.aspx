    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_DimDepartmentGroup" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="DepartmentGroupKey" Font-Size="Medium"
                    OnItemCommand="grddbo_DimDepartmentGroup_ItemCommand" OnSortCommand="grddbo_DimDepartmentGroup_SortCommand" OnPageIndexChanged="grddbo_DimDepartmentGroup_PageIndexChanged" >
                    <Columns>
                        <asp:BoundColumn DataField="DepartmentGroupKey" SortExpression="DepartmentGroupKey" HeaderText="Department Group Key" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="DepartmentGroupName" SortExpression="DepartmentGroupName" HeaderText="Parent Department Group Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="DepartmentGroupName" SortExpression="DepartmentGroupName" HeaderText="Department Group Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtDepartmentGroupKey" width="100px" runat="server" CssClass="input" style="float: left; text-align: right;"></asp:textbox>
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
                Parent Department Group Key:
            </div>
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtParentDepartmentGroupKey" width="300px" runat="server" CssClass="input"></asp:DropDownList>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtDepartmentGroupName" width="300px" runat="server" CssClass="input"></asp:textbox>
            </div>
        </div>
        <div style="height: 40px"></div>
    </asp:Panel>
