    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_FactInternetSalesReason" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="SalesOrderNumber" Font-Size="Medium"
                    OnItemCommand="grddbo_FactInternetSalesReason_ItemCommand" OnSortCommand="grddbo_FactInternetSalesReason_SortCommand" OnPageIndexChanged="grddbo_FactInternetSalesReason_PageIndexChanged" >
                    <Columns>
                        <asp:BoundColumn DataField="ProductKey" SortExpression="ProductKey" HeaderText="Sales Order Number" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="ProductKey" SortExpression="ProductKey" HeaderText="Sales Order Line Number" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="SalesReasonName" SortExpression="SalesReasonName" HeaderText="Sales Reason Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtSalesOrderNumber" width="300px" runat="server" CssClass="input"></asp:DropDownList>
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtSalesOrderLineNumber" width="300px" runat="server" CssClass="input"></asp:DropDownList>
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtSalesReasonKey" width="300px" runat="server" CssClass="input"></asp:DropDownList>
