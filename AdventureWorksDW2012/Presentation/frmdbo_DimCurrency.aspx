...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_DimCurrency" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="CurrencyKey" Font-Size="Medium"
                    OnItemCommand="grddbo_DimCurrency_ItemCommand" OnSortCommand="grddbo_DimCurrency_SortCommand" OnPageIndexChanged="grddbo_DimCurrency_PageIndexChanged" >
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CurrencyAlternateKey" SortExpression="CurrencyAlternateKey" HeaderText="Currency Alternate Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="CurrencyName" SortExpression="CurrencyName" HeaderText="Currency Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
                Currency Alternate Key:
            </div>
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtCurrencyAlternateKey" width="300px" runat="server" CssClass="input"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvCurrencyAlternateKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtCurrencyAlternateKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtCurrencyName" width="300px" runat="server" CssClass="input"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvCurrencyName" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtCurrencyName"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="height: 40px"></div>
    </asp:Panel>
