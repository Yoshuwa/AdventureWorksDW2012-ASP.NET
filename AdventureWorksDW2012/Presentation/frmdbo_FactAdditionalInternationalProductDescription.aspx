...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_FactAdditionalInternationalProductDescription" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="ProductKey" Font-Size="Medium"
                    OnItemCommand="grddbo_FactAdditionalInternationalProductDescription_ItemCommand" OnSortCommand="grddbo_FactAdditionalInternationalProductDescription_SortCommand" OnPageIndexChanged="grddbo_FactAdditionalInternationalProductDescription_PageIndexChanged" >
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CultureName" SortExpression="CultureName" HeaderText="Culture Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="ProductDescription" SortExpression="ProductDescription" HeaderText="Product Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtCultureName" width="300px" runat="server" CssClass="input"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvCultureName" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtCultureName"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtProductDescription" width="300px" runat="server" CssClass="input"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvProductDescription" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtProductDescription"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="height: 40px"></div>
    </asp:Panel>
