    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_FactSurveyResponse" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="SurveyResponseKey" Font-Size="Medium"
                    OnItemCommand="grddbo_FactSurveyResponse_ItemCommand" OnSortCommand="grddbo_FactSurveyResponse_SortCommand" OnPageIndexChanged="grddbo_FactSurveyResponse_PageIndexChanged" >
                    <Columns>
                        <asp:BoundColumn DataField="SurveyResponseKey" SortExpression="SurveyResponseKey" HeaderText="Survey Response Key" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                        ...
                        <asp:BoundColumn DataField="CustomerKey" SortExpression="CustomerKey" HeaderText="Customer Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtSurveyResponseKey" width="100px" runat="server" CssClass="input" style="float: left; text-align: right;"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvSurveyResponseKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtSurveyResponseKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
