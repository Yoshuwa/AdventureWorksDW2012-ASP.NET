    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_FactFinance" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="FinanceKey" Font-Size="Medium" >
                    <Columns>
                        <asp:BoundColumn DataField="FinanceKey" SortExpression="FinanceKey" HeaderText="Finance Key" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="DateKey" SortExpression="DateKey" HeaderText="Date Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="OrganizationName" SortExpression="OrganizationName" HeaderText="Organization Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="DepartmentGroupName" SortExpression="DepartmentGroupName" HeaderText="Department Group Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="ScenarioName" SortExpression="ScenarioName" HeaderText="Scenario Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="ParentAccountKey" SortExpression="ParentAccountKey" HeaderText="Account Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="Amount" SortExpression="Amount" HeaderText="Amount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtFinanceKey" width="100px" runat="server" CssClass="input" style="float: left; text-align: right;"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvFinanceKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtFinanceKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtOrganizationKey" width="300px" runat="server" CssClass="input"></asp:DropDownList>
                <asp:RequiredFieldValidator id="rfvOrganizationKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtOrganizationKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtDepartmentGroupKey" width="300px" runat="server" CssClass="input"></asp:DropDownList>
                <asp:RequiredFieldValidator id="rfvDepartmentGroupKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtDepartmentGroupKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtScenarioKey" width="300px" runat="server" CssClass="input"></asp:DropDownList>
                <asp:RequiredFieldValidator id="rfvScenarioKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtScenarioKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:DropDownList id="txtAccountKey" width="300px" runat="server" CssClass="input"></asp:DropDownList>
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtAmount" width="100px" runat="server" CssClass="input" style="float: left; text-align: right;"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvAmount" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtAmount"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
