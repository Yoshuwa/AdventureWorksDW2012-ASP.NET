    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_FactCurrencyRate" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="CurrencyKey" Font-Size="Medium"
                    OnItemCommand="grddbo_FactCurrencyRate_ItemCommand" OnSortCommand="grddbo_FactCurrencyRate_SortCommand" OnPageIndexChanged="grddbo_FactCurrencyRate_PageIndexChanged" >
                    <Columns>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                ...
                <asp:RequiredFieldValidator id="rfvAverageRate" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtAverageRate"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
            ...
            <div style="display: inline-block; width: 300px;">
                ...
                <asp:RequiredFieldValidator id="rfvEndOfDayRate" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtEndOfDayRate"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
