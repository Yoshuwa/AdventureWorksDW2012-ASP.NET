    ...
    <asp:Panel ID="pnlGrid" Visible="True" runat="server">
        ...
        <div style="text-align: center;">
            <div style="display: inline-block; overflow: auto;">
                ...
                <%-------------------------------------%>
                <asp:datagrid id="grddbo_FactSalesQuota" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="SalesQuotaKey" Font-Size="Medium"
                    OnItemCommand="grddbo_FactSalesQuota_ItemCommand" OnSortCommand="grddbo_FactSalesQuota_SortCommand" OnPageIndexChanged="grddbo_FactSalesQuota_PageIndexChanged" >
                    <Columns>
                        <asp:BoundColumn DataField="SalesQuotaKey" SortExpression="SalesQuotaKey" HeaderText="Sales Quota Key" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                        ...
                        <asp:BoundColumn DataField="SalesAmountQuota" SortExpression="SalesAmountQuota" HeaderText="Sales Amount Quota"  DataFormatString="{0:C}" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                        <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:Label runat="server" Width="10px"></asp:Label>
                            </ItemTemplate>
    ...
    <asp:Panel ID="pnlForm" Visible="False" runat="server">
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtSalesQuotaKey" width="100px" runat="server" CssClass="input" style="float: left; text-align: right;"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvSalesQuotaKey" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtSalesQuotaKey"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
        ...
        <div style="text-align: center;">
            ...
            <div style="display: inline-block; width: 300px;">
                <asp:textbox id="txtSalesAmountQuota" width="100px" runat="server" CssClass="input" style="float: left; text-align: right;"></asp:textbox>
                <asp:RequiredFieldValidator id="rfvSalesAmountQuota" runat="server" ErrorMessage="Required!" Display="Dynamic" ControlToValidate="txtSalesAmountQuota"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 100px; text-align: left;">
